...
const getRevenue = async (instructorId, filters = {}) => {
...
const listReviews = (instructorId) => Review.findAll({
  include: [
    {
      model: Course,
...
const replyToReview = async (reviewId, instructorId, reply) => {
...
module.exports = { getRevenue, listReviews, replyToReview };
