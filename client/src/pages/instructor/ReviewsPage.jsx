...
export default function ReviewsPage() {
  ...
  return (
    <section>
      <div className="mb-6"><div className="mb-2 flex items-center gap-2 text-primary"><MessageSquare size={20} /><span className="text-sm font-bold uppercase tracking-wider">UC12 Reply Reviews</span></div><h1 className="text-3xl font-bold text-slate-900">Student reviews</h1><p className="mt-2 text-gray-500">Respond only to reviews attached to your own courses.</p></div>
