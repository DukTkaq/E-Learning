...
export default function CourseApprovalToolbar({
  status,
  search,
  onStatusChange,
  onSearchChange,
    ...
    <div className="mb-6 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <form
          ...
          className="flex min-w-0 overflow-hidden rounded-xl border border-gray-200 lg:w-80"
        >
          ...
          <button
            type="submit"
            className="bg-slate-900 px-4 text-sm font-semibold text-white"
          >
            Search
          </button>
        </form>
