...
export const fetchInstructorCourses = (params = {}) =>
  api.get("/instructor/courses", { params });
export const fetchInstructorCourse = (courseId) =>
