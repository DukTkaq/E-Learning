...
export const fetchLessons = (courseId, params = {}) => api.get(`/instructor/courses/${courseId}/lessons`, { params });
...
export const fetchQuiz = (courseId, lessonId, params = {}) => api.get(quizBase(courseId, lessonId), { params });
